<script>
    $(document).ready(function () {
        ...
        $('#btnAddRecord').on('click', function() { openModal($page.data('create-url'), 'Create New Header Setting'); });
        $(document).on('click', '.btn-edit', function() { openModal($(this).data('url'), 'Edit Header Setting'); });
        $(document).on('click', '.btn-show', function() { openModal($(this).data('url'), 'Header Setting Details'); });
