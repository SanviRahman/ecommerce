<script>
    $(document).ready(function () {
                    ...
                    $('#sortable-tbody').sortable({
                        ...
                        update: function(event, ui) {
                            ...
                            $.post($page.data('sort-url'), { ids: ids }, function(res) {
                                ...
                                Swal.fire('Error', 'Failed to reorder reviews.', 'error');
                            });
                        }
                    }).disableSelection();
                }
        ...
        $('#btnAddRecord').on('click', function() { openModal($page.data('create-url'), 'Create New Review'); });
        $(document).on('click', '.btn-edit', function() { openModal($(this).data('url'), 'Edit Review'); });
        $(document).on('click', '.btn-show', function() { openModal($(this).data('url'), 'Review Details'); });
