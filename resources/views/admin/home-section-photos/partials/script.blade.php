    ...
    $(document).ready(function () {
        ...
        function loadData(url = $page.data('index-url')) {
            ...
            let params = {
                ...
                section_key: $('#filter_section').val()
            };
                    ...
                    $('#sortable-tbody').sortable({
                        ...
                        update: function(event, ui) {
                            ...
                            $.post($page.data('sort-url'), { ids: ids }, function(res) {
                                ...
                                Swal.fire('Error', 'Failed to reorder photos.', 'error');
                            });
                        }
                    }).disableSelection();
                }
        ...
        $('#btnSearch, #filter_section').on('change click', function(e) {
            if(e.type === 'click' || this.id === 'filter_section') {
                loadData();
            }
        });
        ...
        $('#btnAddRecord').on('click', function() { openModal($page.data('create-url'), 'Create New Photo'); });
        $(document).on('click', '.btn-edit', function() { openModal($(this).data('url'), 'Edit Photo'); });
        $(document).on('click', '.btn-show', function() { openModal($(this).data('url'), 'Photo Details'); });
