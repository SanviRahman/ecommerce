<script>
    $(document).ready(function () {
        ...
        $('#btnAddRecord').on('click', function() { openModal($page.data('create-url'), 'Create New Footer Link'); });
        $(document).on('click', '.btn-edit', function() { openModal($(this).data('url'), 'Edit Footer Link'); });
        $(document).on('click', '.btn-show', function() { openModal($(this).data('url'), 'Footer Link Details'); });
