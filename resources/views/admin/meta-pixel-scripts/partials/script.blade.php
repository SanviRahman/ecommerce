    ...
    $(document).ready(function () {
        ...
        function loadData(url = $page.data('index-url')) {
            ...
            let params = {
                ...
                placement: $('#filter_placement').val()
            };
        ...
        $('#btnSearch, #filter_placement').on('change click', function(e) {
            if(e.type === 'click' || this.id === 'filter_placement') {
                loadData();
            }
        });
        ...
        $('#btnAddRecord').on('click', function() { openModal($page.data('create-url'), 'Create New Script'); });
        $(document).on('click', '.btn-edit', function() { openModal($(this).data('url'), 'Edit Script'); });
        $(document).on('click', '.btn-show', function() { openModal($(this).data('url'), 'Script Details'); });
