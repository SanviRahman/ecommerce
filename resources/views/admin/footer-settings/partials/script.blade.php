<script>
    $(document).ready(function () {
        ...
        $('#btnAddRecord').on('click', function() { openModal($page.data('create-url'), 'Create New Footer Setting'); });
        $(document).on('click', '.btn-edit', function() { openModal($(this).data('url'), 'Edit Footer Setting'); });
        $(document).on('click', '.btn-show', function() { openModal($(this).data('url'), 'Footer Setting Details'); });
