<script>
    $(document).ready(function () {
        ...
        $('#btnAddRecord').on('click', function() { openModal($page.data('create-url'), 'Create New Menu Item'); });
        $(document).on('click', '.btn-edit', function() { openModal($(this).data('url'), 'Edit Menu Item'); });
        $(document).on('click', '.btn-show', function() { openModal($(this).data('url'), 'Menu Item Details'); });
