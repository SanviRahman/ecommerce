<script>
    $(document).ready(function () {
        ...
        $('#btnSearch, #filter_status').on('change click', function(e) {
            if(e.type === 'click' || this.id === 'filter_status') {
                loadData();
            }
        });
        ...
        $('#btnAddRecord').on('click', function() { openModal($page.data('create-url'), 'Create New Message'); });
        $(document).on('click', '.btn-edit', function() { openModal($(this).data('url'), 'Manage Message'); });
        $(document).on('click', '.btn-show', function() { openModal($(this).data('url'), 'View Message Details'); });
