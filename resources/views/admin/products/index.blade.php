...
@section('content')
    <div id="page-manager"
         ...
         data-bulk-url="{{ route('admin.products.multiple_action') }}"
         data-sort-url="{{ route('admin.products.sort') }}"
         data-trash-url="{{ route('admin.products.trashed') }}">
        ...
        <div class="d-flex align-items-center flex-wrap mb-3" style="gap: 6px;">
            ...
            @can('product_trash')
                <a href="{{ route('admin.products.trashed') }}" class="btn btn-outline-danger btn-sm font-weight-bold shadow-sm">
            ...
            <div class="card-body px-3 py-2">
                <div class="row align-items-end">
                    <div class="col-md-3 mb-2 mb-md-0">
                        <label for="filter_category" class="text-muted small font-weight-bold text-uppercase mb-1">Filter By Category</label>
                        <select id="filter_category" class="form-control form-control-sm shadow-none">
                    ...
                    <div class="col-md-7 mb-2 mb-md-0">
                        <label for="table_search" class="text-muted small font-weight-bold text-uppercase mb-1">Search Products</label>
                        <div class="input-group input-group-sm">
                            <input type="text" id="table_search" class="form-control shadow-none" autocomplete="off" placeholder="Search by name, SKU or slug...">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white px-3 py-3 border-bottom">
                    <h3 class="card-title font-weight-bold text-dark mb-0">
                        <i class="fas fa-box text-primary mr-1"></i>Products List (Drag & Drop to Sort)
                    </h3>
                </div>
                <div class="card-body p-0" id="content-wrapper" style="min-height: 340px;">
                    @include('admin.products.partials.table', ['products' => $products, 'isTrash' => false])
                </div>
            </div>
        @else
            <div class="alert alert-warning border-0 shadow-sm mt-4 font-weight-bold">
                <i class="fas fa-exclamation-triangle mr-2"></i> You do not have permission to view products.
            </div>
        @endcan
    </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header border-bottom-0 pb-0">
                    <h5 class="modal-title font-weight-bold text-primary" id="modal-title">Product Management</h5>
